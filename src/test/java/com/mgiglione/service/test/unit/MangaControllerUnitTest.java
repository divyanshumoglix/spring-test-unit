...
public class MangaControllerUnitTest {
    ...
    public void setup() throws Exception {
        ...
        Manga manga1 = new Manga("Hokuto no ken", "The year is 199X. The Earth has been devastated by nuclear war...");

        Manga manga2 = new Manga("Yumekui Kenbun", "For those who suffer nightmares, help awaits at the Ginseikan Tea House, where patrons can order much more than just Darjeeling. Hiruko is a special kind of a private investigator. He's a dream eater....");;
